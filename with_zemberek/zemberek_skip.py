...
# -*- coding: utf-8 -*-
"""
Created on Fri May 24 14:52:02 2019
...
model = Word2Vec(sentences_stem, min_count =4, size = size, window = 7, sg = 1) 
...
print("Cosine similarity between 'um (um-mak)' and 'insallah' - Skip Gram : ", model.wv.similarity('um', 'insallah')) 
